    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6f46e3d8-3485-4044-8eda-ce18b707d63c", "45a1ff55-fd12-46e3-80cc-cfa8c890da9c", "User", null },
                    { "ca280558-67b1-4d9e-a388-b7f5038c0e15", "9adb1e72-ab88-4801-8cc4-0d4d7e3693f6", "Admin", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "BrandId", "ImageUrl", "IsActive", "Name", "Price", "Quantity", "Type" },
                values: new object[,]
                {
                    { 1, 5, "https://i.pinimg.com/564x/f5/7f/c3/f57fc31f3e0629c3ef481e8459e99cf0.jpg", true, "Champion winter hat", 30.00m, 5, "Hat" },
                    { 2, 1, "https://i.pinimg.com/564x/90/52/13/905213317d3bed8971d4164f0323fb04.jpg", true, "Nike cap", 45.00m, 5, "Cap" },
                    { 3, 1, "https://i.pinimg.com/564x/60/32/b3/6032b3977c6e276780b9b39d89ac705a.jpg", true, "Nike Thermo Mask", 50.00m, 5, "Mask" },
                    { 4, 1, "https://i.pinimg.com/564x/e9/b7/ce/e9b7ceb439600eb81285255fa00ce157.jpg", true, "Nike long socks", 20.00m, 10, "Socks" }
                });

            migrationBuilder.InsertData(
                table: "Shoes",
                columns: new[] { "Id", "BrandId", "Color", "ImageUrl", "IsActive", "Model", "Price", "TypeId" },
                values: new object[] { 1, 1, "Black and White", "https://i.pinimg.com/564x/f7/0c/21/f70c21947cf4630a184d9728e7077bdf.jpg", true, "Nike Air Max 97", 420.00m, 1 });
